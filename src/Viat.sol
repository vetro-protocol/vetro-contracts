...
/// @title Viat aka ViaToken, A stablecoin backed by yield-generating collateral.
contract Viat is ERC20Permit, ERC20Burnable, Ownable2Step {
    ...
    /**
     * @notice Burn Viat e.g viaUSD from account.
     * The caller must have allowance for accounts's tokens.
     * If Gateway is the caller then approval is not required.
     * @param account_ Viat will be burnt from this address
     * @param amount_ Viat amount to burn
     *
    ...
    /**
     * @notice onlyGateway:: Mint Viat e.g. viaUSD
     * @param account_ Address where Viat will be minted
     * @param amount_ Viat amount to mint
     */
    ...
    /**
     * @notice Update Viat gateway address
    ...
    /**
     * @notice Update Viat treasury address
